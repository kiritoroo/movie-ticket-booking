...
import com.ute.movie_ticket_booking.databinding.ItemUpComingMovieBinding;
...
public class UpComingMovieViewPagerAdapter extends PagerAdapter implements View.OnTouchListener {
  ...
  public Object instantiateItem(@NonNull ViewGroup container, int position) {
    ...
    final ItemUpComingMovieBinding view = ItemUpComingMovieBinding.inflate(LayoutInflater.from(context), container, false);
    ...
    view.movieGenre.setText(strGenres);
    ...
    Picasso.get().load(movie.getPosterPath()).into(view.moviePoster);
    ...
    view.cardView.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View anotherView) {
        ...
        ActivityOptionsCompat options = ActivityOptionsCompat
            .makeSceneTransitionAnimation((Activity) context, view.imageCardView, String.valueOf(1));
